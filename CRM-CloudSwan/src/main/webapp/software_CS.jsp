...
<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  <h3 class="card-title"><b>Software Details</b></h3>
                </div>
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Software name</label><br>
						...
						<div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Change made</label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Developer name</label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Technology name</label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
						...
						<div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Cost on changes</label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Service time</label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
						...
						<div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Delivery date</label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
...
<div class="card">
                <div class="card-body">
 				...
 				<div class="row">
                    <div class="col-md-5"></div>
                      <div class="col-md-6">
						<a href="dashboard_CS.jsp"><button class="btn btn-info">Save</button></a>
                      </div>
                    </div>
                      </form>
                      </div>
     ...
     <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  <h4 class="card-title">List of Software Details</h4>
                    </div>
