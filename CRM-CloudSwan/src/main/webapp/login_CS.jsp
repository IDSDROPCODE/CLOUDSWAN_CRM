...
<div class="col-md-8">
          ...
          <div class="row">
			<div class="col-md-2"><img src="img/CS_img.png" width="80%" height="80%"></div>
			<div class="col-md-8"><h1>Login</h1><h2>Get started today</h2></div>
 		</div>
                </div>
                <div class="card-body">
...
<p>Copyright <script>
            ...
            </script> &copy; CloudSwan solutions. All Rights Reserved.<a href="#"><b>&nbsp;Privacy Policy</b></a></p></div>
<div class="col-md-3">
<p>Designed and developed by CloudSwan team</p>
</div>
</div>
</div>
