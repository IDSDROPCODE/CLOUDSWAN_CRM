      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Enquiry Information</a>
          </div>
                ...
                <div class="card-body">
                  <form>
                    <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100" name="txtcompanyname" id="txtcompanyname" class="enquirycolor"></textarea>
                        </div>
                      </div>
                      </div>
                                          <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100" name="txtcontactname" id="txtcontactname" class="enquirycolor" ></textarea>
                        </div>
                      </div>
                      </div>
                                          <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100" name="txtprojectname" id="txtprojectname" class="enquirycolor"></textarea>
                        </div>
                      </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100" name="txtprojectmgr" id="txtprojectmgr" class="enquirycolor"></textarea>
                        </div>
                      </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100" name="txtprojectdate" id="txtprojectdate" class="enquirycolor" ></textarea>
                        </div>
                      </div>
                      </div>
					<div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100" name="txtprojectlocation" id="txtprojectlocation" class="enquirycolor" ></textarea>
                        </div>
                      </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100"  name="txtintendedapplication" id="txtintendedapplication" class="enquirycolor"></textarea>
                        </div>
                      </div>
                      </div>
                  <div class="row">
                      ...
                      <div class="col-md-10">
                        <div class="form-group">
                          <textarea rows="1" cols="100" name="txtinterstedin" id="txtinterstedin" class="enquirycolor" ></textarea>
                        </div>
                      </div>
                      </div>
...
<a href="login_CS.jsp"><button class="btn btn-info">Submit</button></a>
</div>
</div>
