              ...
              <div class="card">
                  ...
                  <form>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Release date</label><br>
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Follow up date</label><br>
                          <input type="date" class="form-control">
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Email Notification Message </label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Payment details  </label><br>
                          <input type="text" class="form-control">
                          </div>
                        </div>
					</div>
                ...
                <div class="row">
                    <div class="col-md-5"></div>
                      <div class="col-md-6">
						<a href="#"><button class="btn btn-info">Send Email</button></a>
                      </div>
                    </div>
                    </form>  
                    </div>  
