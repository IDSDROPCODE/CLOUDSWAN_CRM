...
<div class="col-md-6">
                ...
                <div class="card-body">
                  <form>
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Total no of modules<span class="text-danger">*</span></label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Module name<span class="text-danger">*</span></label>
                          <input type="text" class="form-control">
                          <input type="text" class="form-control">
                          <input type="text" class="form-control">
                          <input type="text" class="form-control">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Sub modules<span class="text-danger">*</span></label>
                          <input type="text" class="form-control">
                          <input type="text" class="form-control">
                          <input type="text" class="form-control">
                          <input type="text" class="form-control">
        ...
        <option>Sub modules 1 name</option>
        <option>Trainee module </option>
        ...
        <option>Software module</option>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="txtdesc" id="txtdesc" rows="4" cols="70" placeholder="Enter your description here....."></textarea>
                        </div>
                      </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
        <select id="inputState" class="form-control bmd-label-floating">
        <option>Sub modules 2 name</option>
        <option>Trainee module </option>
        <option>Admin module </option>
        <option>Course Module</option>
        <option>Employee Module</option>
        <option>Software module</option>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
        <select id="inputState" class="form-control bmd-label-floating">
        <option>Sub modules 3 name</option>
        <option>Trainee module </option>
        <option>Admin module </option>
        <option>Course Module</option>
        <option>Employee Module</option>
        <option>Software module</option>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Additional Features</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <h5>Comments</h5>
                          <textarea name="txtdesc" id="txtdesc" rows="4" cols="70" placeholder="Enter your comments here....."></textarea>
                          <h5>Description</h5>
                          <textarea name="txtdesc" id="txtdesc" rows="4" cols="70" placeholder="Enter your Description here......"></textarea>
...
<div class="col-md-6">
              <div class="card h-85">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Client name<span class="text-danger">*</span></label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Business name<span class="text-danger">*</span></label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      </div>
              ...
              <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Street<span class="text-danger">*</span></label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      </div>
...
<div class="col-md-6">
              <div class="card h-90">
                <div class="card-header card-header-info">
                  <h3 class="card-title">Software Requirement</h3>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
        ...
        <option>Any</option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Software development kit:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Scripting language:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Framework:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Database connection:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Website design:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Validations:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Event handlers:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">XML parsing:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Server technology:</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>                  
...
<div class="col-md-6">
              <div class="card h-90">
                <div class="card-header card-header-info">
                  <h3 class="card-title">Project cost estimation & Duration</h3>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Estimation duration </label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
        ...
        <option>Yearly</option>
                      ...
                      <div class="row">
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Working time</label><br>
                	</div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <select id="inputState" class="form-control bmd-label-floating">
        <option>Working resource (in no)</option>
        <option>1</option>
        <option>2</option>
        <option>3</option>
        <option>4</option>
        <option>5</option>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Monthly cost estimation per resource</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Total monthly cost</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Website design cost</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Logo design cost (if any)</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>                
...
<div class="col-md-6">
              <div class="card vh-90">
                <div class="card-header card-header-info">
                  <h3 class="card-title">Featuring cost</h3>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Payment gateway </label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Report generated </label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="row">
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Email notification</label><br>
                	</div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Responsive </label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Total estimated cost</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Per changes cost</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                    </div>               
