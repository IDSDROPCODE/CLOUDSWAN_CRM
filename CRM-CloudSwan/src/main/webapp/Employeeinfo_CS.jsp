      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Employee Info</a>
          </div>
...
<div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  <h3 class="card-title"><b>Employee Inforamtion</b></h3>
                </div>
                <div class="card-body">
                  <form>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <label class="bmd-label-floating">Employee ID</label><br>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Employee name</label><br>
                          <input type="search" class="form-control">
                          </div>
                        </div>
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Email ID</label><br>
